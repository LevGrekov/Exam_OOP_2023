    ...
    private function ShowAuth()
    {
        ...
        <div class="card mx-auto" style="max-width: 400px;">
            ...
            <form method="POST">
                ...
                <button type="submit" class="btn  btn-block my-2" style="background-color: pink;">Войти</button>
            </form>
            ...
            <div class="card mx-auto" style="max-width: 400px;">
                <div class="card-body">
                    ...
                    <form method="POST">
                        ...
                        <button type="submit" class="btn  btn-block my-2" style="background-color: pink;">Зарегистрироваться</button>
                    </form>
